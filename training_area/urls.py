...
urlpatterns = [
    ...
    path('coach/', include(([
        ...
        #path('own_profile_view/athlete=<str:slug>', coach.ProfileView.as_view(), name = 'own_profile_view'),
        #path('change_profile', coach.change_profile, name = 'change profile'),
        #path('delete_workout/<int:user_id>/<int:workout_id>', coach.WorkoutDeleteView.as_view(), name = 'delete_workout'),
        #path('delete_workout/<int:workout_id>', coach.WorkoutDeleteView.as_view(), name = 'delete_workout'),
        #path('athlete=<int:pk>', coach.AthleteDetailView.as_view(), name = 'view_athlete_profile'),
        #path('athlete=<int:pk>/log', coach.AthleteLogView.as_view(), name = 'view_athlete_log'),
        #path('athlete=<int:pk>/all_program', coach.ListProgramView.as_view(), name = 'all_programs'),
        #path('athlete=<int:pk>/create_program', coach.CreateProgramView.as_view(), name = 'create_program'),
        #path('athlete=<int:pk>/program=<int:pk_2>/create_meso', coach.CreateMesoView.as_view(), name = 'create_meso'),
        #path('athlete=<int:pk>/program=<int:pk_2>/program_view', coach.ProgramDetailView.as_view(), name = 'program_view'),
        #path('athlete=<int:pk>/program=<int:pk_2>/meso=<int:pk_3>', coach.MesoDetailView.as_view(), name = 'meso_view'),
        #path('athlete=<int:pk>/program=<int:pk_2>/all', coach.MesoListView.as_view(), name = 'all_mesocycles'),
        #path('athlete=<int:pk>/program=<int:pk_2>/meso=<int:pk_3>/create_micro', coach.CreateMicroView.as_view(), name = 'create_micro'),
        #path('athlete=<int:pk>/program=<int:pk_2>/meso=<int:pk_3>/micro=<int:pk_4>', coach.MicroDetailView.as_view(), name = 'micro_view'),
        #path('athlete=<int:pk>/program=<int:pk_2>/meso=<int:pk_3>/micro=<int:pk_4>/create_wo', coach.CreateWoView.as_view(), name = 'create_wo'),
        #path('athlete=<int:pk>/program=<int:pk_2>/meso=<int:pk_3>/micro=<int:pk_4>/wo=<int:pk_5>', coach.WoDetailView.as_view(), name = 'wo_view'),
        #path('athlete=<int:pk>/program=<int:pk_2>/meso=<int:pk_3>/micro=<int:pk_4>/wo=<int:pk_5>/create_mo', coach.CreateMovementView.as_view(), name = 'create_mo'),
